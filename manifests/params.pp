...
class hadoop::params {
  ...
  $descriptions = {
    ...
    'dfs.datanode.address' => 'different port with security enabled (original port 50010/9867)',
    'dfs.datanode.http.address' => 'different port with security enabled (original port 50075/9864)',
